...
public final class DataPacket {
    ...
    public static class TYPE {
        ...
        /** 考勤 */
        public static final int ATTENDANCE = 2001;
    }
    ...
    public static DataPacket build(int way) {
        return new DataPacket(way, DataPacket.TYPE.DEFAULT, DataPacket.EXTRA.DEFAULT);
    }
    public static DataPacket build(int way, int type) {
        return new DataPacket(way, type, DataPacket.EXTRA.DEFAULT);
    }
