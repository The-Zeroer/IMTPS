package imtps.server.datapacket.code;
...
public class Type {
    ...
    /** 主动 */
    public static final int INITIATIVE = 301;
    /** 变动 */
    public static final int PASSIVITY = 302;

    /** 基础连接 */
    public static final int BASE_LINK = 901;
    /** 文件传输连接 */
    public static final int FILE_LINK = 902;
    /** web服务连接 */
    public static final int WEB_LINK = 903;
    /** 考勤 */
