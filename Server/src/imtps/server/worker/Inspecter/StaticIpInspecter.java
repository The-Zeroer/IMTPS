package imtps.server.worker.Inspecter;

import imtps.server.address.Subnet;
...
public final class StaticIpInspecter extends Inspecter {
    ...
    /** 过滤模式 */
    private StaticIpInspecter.Pattern pattern;
    ...
    public StaticIpInspecter() {
        ...
        pattern = StaticIpInspecter.Pattern.CLOSE;
    }
