...
public abstract class ImtpsTask implements Runnable {
    ...
    private IMTPS_Client imtpsClient;
    ...
    public void putRequestDataPacket(DataPacket dataPacket) {
        imtpsClient.putDataPacket(dataPacket.setTaskId(taskId));
    }
    ...
    void entrustObject(ExecutorService threadPool, ProcessingHub processingHub, IMTPS_Client imtpsClient) {
        this.threadPool = threadPool;
        this.processingHub = processingHub;
        this.imtpsClient = imtpsClient;
    }
