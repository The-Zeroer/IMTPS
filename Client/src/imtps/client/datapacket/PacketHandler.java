package imtps.client.datapacket;

import imtps.client.buffer.BufferManager;
...
import imtps.client.security.ImtpsSecretKey;
import imtps.client.view.AbstractTransmitView;
    ...
    public DataPacket readDataPacket(SelectionKey selectionKey, ImtpsSecretKey imtpsSecretKey) throws Exception {
        ...
        try {
            ...
            if (bodyMap.get(dataPacket.getDataBodyId()) instanceof Supplier<? extends AbstractDataBody<?>> supplier) {
                ...
                if (receiveViewMap.remove(dataPacket.getTaskId()) instanceof AbstractTransmitView receiveView) {
    ...
    public void writeDataPacket(SelectionKey selectionKey, ImtpsSecretKey imtpsSecretKey, DataPacket dataPacket) throws Exception {
        ...
        try {
            ...
            if (dataBody != null) {
                ...
                if (sendViewMap.remove(dataPacket.getTaskId()) instanceof AbstractTransmitView sendView) {
